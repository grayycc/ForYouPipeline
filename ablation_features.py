"""Wires in CWM's 13 feature fields to verify "whether user-side features are useful in FM"."""
...
def build(mode):
    """mode: 'base'=5 fields (current kit) / 'item'=item-side only added / 'cwm13'=CWM's full 13 fields"""
